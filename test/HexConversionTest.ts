...
describe('Hex conversion test', () => {
    it('can convert string to bytes', () => {
        ...
        var expected = [
            60,2,153,146,105,193,128,102,43,26,99,12,48,158,159,85,55,95,76,239,20,91,148,252,202,46,255,0,117,232,114,177,
        ];
    ...
    it('can convert string ID to bytes 2', () => {
        var converted = stringToAsciiByteArray(HandshakeProtoID);
        var result = [
            120,112,120,45,99,117,114,118,101,50,53,53,49,57,45,115,104,97,50,53,54,45,48,49,
        ];
